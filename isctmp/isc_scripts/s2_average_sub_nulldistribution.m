% this scripts avrage all null distribution generated in
% each listening sub with the reading group 
% null distribution are created, the values at 
%  0.05   0.01   0.005   0.001  
% also are output as threshold
