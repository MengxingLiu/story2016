...
################ group level statistic #################
	...
	3dMVM -prefix "$hemi"_group_MVM -jobs 12 \
			...
			s3	Listen	CS	"$spath"/sub03/surface_files/"$hemi"_GLM_glts.1D'[6]' \
			s3	Listen	US	"$spath"/sub03/surface_files/"$hemi"_GLM_glts.1D'[8]' \
			s3	Listen	SW	"$spath"/sub03/surface_files/"$hemi"_GLM_glts.1D'[10]' \
			...
			s21	Read	CS	"$spath"/sub21/surface_files/"$hemi"_GLM_glts.1D'[6]' \
			s21	Read	US	"$spath"/sub21/surface_files/"$hemi"_GLM_glts.1D'[8]' \
			s21	Read	SW	"$spath"/sub21/surface_files/"$hemi"_GLM_glts.1D'[10]' \
...
#			rm "$hemi"_group_MVM.dset
			3dSurf2Vol \
				...
				-prefix ./"$hemi"_group_MVM_sb
			bzip2 "$hemi"_group_MVM.dset
		end
rm group_MVM+tlrc.nii.gz
3dcalc \
	-float \
	-a lh_group_MVM_sb+tlrc. \
	-b rh_group_MVM_sb+tlrc. \
	-expr '(a+b)' \
	-prefix group_MVM+tlrc.nii.gz 
