...
foreach paras("01_Intercept 0 9.284 32" "02_Modality 1 9.284 21" \
		...
		"09_Read_US 13 3.047 31" "10_Read_SW 15 3.047 32" \
		...
		"17_Read_CS-SW 29 3.047 21" "18_Read_US-SW 31 3.047 22" \
		"19_Read-Listen 33 3.047 15" "20_Listen_Trend 35 2.807 25" "21_Read_Trend 37 2.807 21") 
	...
	3dclust -prefix "$con"_clustmask.nii.gz \
		...
		/public/home/max/story2016fMRI/group/MVM/group_MVM+TREND.nii.gz\["$thindex"]
